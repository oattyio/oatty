  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Suggested commands or workflows are surfaced for operator review before run.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Use preview and validation tools to catch schema, dependency, and input issues early.',
      ...
      callouts: [
        ...
        { type: 'recovery', content: 'If a step fails validation, correct the reported field/dependency and run validation again before execution.' },
        { type: 'advanced', content: 'For workflows, `workflow.resolve_inputs` is the best pre-run readiness checkpoint.' },
      ],
    },
    {
      id: 'operator-control',
      ...
      callouts: [
        { type: 'tip', content: 'For production changes, prefer explicit command/workflow review over one-shot execution.' },
        { type: 'fallback', content: 'Use CLI commands for explicit scriptable execution when you need non-interactive control.' },
      ],
    },
    {
      id: 'failure-recovery',
      ...
      callouts: [
        { type: 'expected', content: 'Most failures should map to a clear next action from validation or error metadata.' },
        {
          type: 'screenshot',
    ...
    },
    {
      ...
      callouts: [{ type: 'expected', content: 'You can evaluate assisted suggestions without sacrificing operator control.' }],
    },
  ],
};
