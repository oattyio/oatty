  ...
  sections: [
    {
      ...
      callouts: [
        ...
        { type: 'screenshot', imageSrc: '/Oatty-library.png', imageAlt: 'Library catalog screenshot', content: 'Capture Library with list, details, and base URL areas visible.' },
      ],
    },
    {
      id: 'import-catalog',
      title: 'Step 1: Import a Catalog',
      ...
      callouts: [
        ...
        { type: 'screenshot', imageSrc: '/Oatty-library.png', imageAlt: 'Library catalog screenshot', content: 'Capture successful import with the new catalog selected.' },
        { type: 'fallback', content: 'CLI fallback: `oatty import <path-or-url> --kind catalog`.' },
        { type: 'advanced', content: 'Imported catalogs become a shared command surface used by TUI, workflows, CLI, and MCP tooling.' },
      ],
    },
    {
      id: 'toggle-enablement',
      title: 'Step 2: Toggle Catalog Enablement',
      ...
      callouts: [
        ...
        { type: 'recovery', content: 'If status does not change, ensure the catalog row is focused before toggling.' },
        { type: 'screenshot', imageSrc: '/Oatty-library.png', imageAlt: 'Library catalog screenshot', content: 'Capture enabled and disabled states for the same catalog.' },
      ],
    },
    {
      id: 'headers-management',
      title: 'Step 3: Define Request Headers',
      ...
      callouts: [
        { type: 'expected', content: 'Header rows are visible in the catalog details and persist after focus changes.' },
        { type: 'recovery', content: 'If headers do not persist, check for invalid/empty header keys and correct the row.' },
        { type: 'screenshot', imageSrc: '/Oatty-library.png', imageAlt: 'Library catalog screenshot', content: 'Capture headers editor with a valid Authorization header row.' },
        { type: 'advanced', content: 'Header validation enforces non-empty header keys before saving.' },
      ],
    },
    {
      id: 'base-url-management',
      title: 'Step 4: Manage Base URLs',
      ...
      callouts: [
        { type: 'expected', content: 'One base URL is marked active and list updates reflect add/remove actions.' },
        { type: 'recovery', content: 'If updates fail validation, correct the base URL value and retry.' },
        { type: 'screenshot', imageSrc: '/Oatty-library.png', imageAlt: 'Library catalog screenshot', content: 'Capture base URL list with active selection and add/remove controls.' },
        { type: 'advanced', content: 'Base URL validation rejects invalid or empty URL sets for a catalog.' },
      ],
    },
    {
      id: 'remove-catalog',
      title: 'Step 5: Remove a Catalog',
      ...
      callouts: [
        ...
        { type: 'screenshot', imageSrc: '/Oatty-library.png', imageAlt: 'Library catalog screenshot', content: 'Capture remove confirmation modal and post-remove list state.' },
        { type: 'advanced', content: 'Removal is destructive. Use confirmation flow to prevent accidental deletion.' },
      ],
    },
    {
      id: 'next-steps',
      ...
      callouts: [
        ...
        { type: 'screenshot', imageSrc: '/Oatty-library.png', imageAlt: 'Library catalog screenshot', content: 'Capture final Library state with stable catalog and base URL configuration.' },
      ],
    },
  ],
};
