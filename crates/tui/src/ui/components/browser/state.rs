...
impl BrowserState {
    pub fn new(registry: Arc<Mutex<oatty_registry::CommandRegistry>>) -> Self {
        Self {
            ...
            input_fields: vec![],
            current_field_idx: 0,
            container_focus: FocusFlag::new().with_name("browser"),
            f_search: FocusFlag::new().with_name("browser.search"),
            f_commands: FocusFlag::new().with_name("browser.commands"),
            f_help: FocusFlag::new().with_name("browser.help"),
