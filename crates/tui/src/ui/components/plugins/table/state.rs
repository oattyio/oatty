...
impl PluginsTableState {
    ...
    pub fn new() -> Self {
        Self {
            ...
            f_start: FocusFlag::new().with_name("plugins.start_or_restart"),
            f_stop: FocusFlag::new().with_name("plugins.stop"),
            f_delete: FocusFlag::new().with_name("plugins.delete"),
            f_edit: FocusFlag::new().with_name("plugins.edit"),
            filter: String::new(),
            items: Vec::new(),
            last_refresh: None,
            cursor_position: 0,
